        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-white text-center">
            ...
            <p className="text-lg max-w-md mx-auto">
              Connect with potential clients and showcase your exceptional work
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-purple-50 via-white to-blue-50">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900">Builder Login</h2>
            <p className="text-gray-600 mt-2">Access your builder dashboard</p>
          </div>
          ...
          {!otpSent ? (
            ...
            <form onSubmit={handleVerifyOTP} className="space-y-6">
              ...
              <button
                ...
                className="w-full text-purple-600 text-sm hover:text-purple-800"
              >
                Change {loginMethod}?
              </button>
            </form>
          ...
          <p className="mt-8 text-center text-sm text-gray-600">
            ...
            <a href="/builder/signup" className="text-purple-600 hover:text-purple-800 font-medium">
              Sign up
            </a>
          </p>

          <div className="mt-6 text-center">
            <a href="/customer/login" className="text-sm text-gray-600 hover:text-gray-800">
              Are you a customer?{" "}
              <span className="text-purple-600 hover:text-purple-800">Login here</span>
            </a>
          </div>
        </div>
      </div>
